    ...
    public class NetworkManager : MonoBehaviour
    {
        ...
        private void OnClientConnected(IAsyncResult ar)
        {
            try
            {
                ...
                client.BeginReceive(clientSession.Buffer, 0, clientSession.Buffer.Length, SocketFlags.None,
                    OnDataReceived,
                    clientSession);

                _playerManager.InitializePlayers(clientSession.PlayerId);
        ...
        private void OnDataReceived(IAsyncResult ar)
        {
            ...
            try
            {
                ...
                if (byteRead > 0)
                {
                    ...
                    session.Socket.BeginReceive(session.Buffer, 0, session.Buffer.Length, SocketFlags.None,
                        OnDataReceived,
                        session);
                }
            }
